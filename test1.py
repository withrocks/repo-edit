...
class FileHandler(tornado.web.RequestHandler):
    ...
    def get(self, fname):  # TODO: relative path to file (to begin with, only support one root location) 
        ...
        root = "/Users/stest683/source/tornado/demos/test1/test-repo/"
        with open(os.path.join(root, fname), 'rb') as fs:
            self.write(fs.read())
